package com.treino.workshopmongo.config;
...
import com.treino.workshopmongo.DTO.AuthorDTO;
import com.treino.workshopmongo.DTO.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("21/03/2019"), "Partiu", "Vou viajar para minas", new AuthorDTO(maria));
